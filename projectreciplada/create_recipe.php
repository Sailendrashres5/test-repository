...
<html>
    ...
    <tr>
        <th>Recipe name: </th>
        <th><input type="text" id="r_name"name="recipe_name" placeholder="Enter recipe name"></th>
    </tr>
    <tr>
        <th>Recipe time: </th>
        <th><input type="text" id="r_time"name="recipe_time" placeholder=""></th>
    </tr>
    <tr>
        <th>Recipe description: </th>
        <th><input type="text" id="r_description" name="recipe_description" placeholder=""></th>
    </tr>
    <tr>
        <th>Recipe direction: </th>
        <th><input type="text" id="r_direction" name="recipe_direction" placeholder=""></th>
    </tr>
    <tr>
        <th>Recipe search keywords: </th>
        <th><input type="text" id="r_keywords" name="recipe_keywords" placeholder=""></th>
    </tr>
    <tr>
        <th><button type="submit" value="submit">Create</button></th>
